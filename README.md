...
│       │   ├── resume_reportfallback.py  # Resume ReportLab renderer (LM Roman 10, name --- [GitHub] --- summary projects)
...
See [CHANGELOG.md](CHANGELOG.md) for the full version history (v1–v28).
